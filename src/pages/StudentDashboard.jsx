...
const stats = [
  ...
  { icon: 'calendar_month', label: 'Upcoming Events', value: '04', tone: 'text-secondary bg-secondary/10' },
  { icon: 'bookmarks', label: 'Saved Opportunities', value: '28', tone: 'text-tertiary bg-tertiary-fixed/40' },
]

const events = [
  { month: 'Oct', day: '15', title: 'UI/UX Workshop', detail: 'Design thinking fundamentals', bg: 'bg-secondary-fixed text-on-secondary-fixed' },
  { month: 'Oct', day: '18', title: 'Career Talk', detail: 'Networking for Engineers', bg: 'bg-primary-fixed text-on-primary-fixed' },
  { month: 'Oct', day: '21', title: 'Coding Hackathon', detail: '24h of building together', bg: 'bg-tertiary-fixed text-on-tertiary-fixed' },
]

const clubs = [
  ['Design Atelier', 'Creative Arts', 'https://lh3.googleusercontent.com/aida-public/AB6AXuAr8B3ozE7cUv05pzf39yYsPgyGHSHng2GZVwGVtS_700XAocmhrzqZiqmY0PyiS0nghe3e1HkcfvxXvqHEWPO5hCsMDgjESOr8o4XbsxNK2F0kghNtCG60D-4VWT3ongYMnc5tUHUSZQfRUOxCXWyHy23PQo8EJOwsv0BfaQ1AIsugqbR9Z53-W-HzT6CceH2OAfgoEMsDIZQQapdZaWnCzrdybOPQUCkb62dVPYETUHLRkon-MZ4eabrfY6MUHJfxiM8WRTDG9kc'],
  ['The Coding Collective', 'Technology', 'https://lh3.googleusercontent.com/aida-public/AB6AXuC79A9r23mQ8Y8Q9_p352ZddEBPiLfUS7NiN4iA53ZE5huv0Tzh73AHLNX-brNFdfocVdgxpcettotPsiKLm-rx-MeBFFdjDob6zBSxVqnp5y6Qfvle-9Z13UZ_KWwJUJN-uMu-Wy6Utz3vp3Kv_GnsOyRTgE2LBZBE-RQowuLTMMwWSwSAa-_f0BqLjTkS3OXFR3Lw8FB8Wj8L8Fq95inbXOd1WP9GQnjao5OO-LxBiPyUHnIKFjNpvK71gEM6fnAbZKy4f_RqZXI'],
  ['Canvas Society', 'Fine Arts', 'https://lh3.googleusercontent.com/aida-public/AB6AXuAIoLknvjDyQealNvWoteyconRoa7EJru_Bu7vttrR-ibaUrKjWlzXDZkI-TGJ11fbT1h3dwIHXmSfTvTzD7U-n_INhtH4ax1wWqnDTu_TggeLLVpF2NQHyqnJXoDIBBrmBpn1r6gn5-SoLoRY7Mk-DxwzYy9Ak9GfsCHZ38c0Ajy7RplUo1eJmjqx_e9odA-9tKO285vGyUSVsHueAZ3KdeAszy-Tbkj3pY8mw4jBoA1jIIcwKeUTMubUvMWwTecESS1SposCAX_Y'],
  ['Student Gov', 'Leadership', 'https://lh3.googleusercontent.com/aida-public/AB6AXuBDMrjwQ0GErY5RoubU0LMIWzjQKuG6gGk0k7GKXGQm6heF8j2poVeDhWq4qmMlJjKnpdZou02pp34P4p8Q_c81MolUL6gQNyjhleOMYjgDljn_H3N-XbenrsUoaQ8OoLpQTmGhF0oa1-_COQtENepbsDRR-c3G324YLkP9dxpqq-K1-mDEzfAz1U0fFRfXxxyAL_SbBMainXsIuhjkF05TEGJW9Zum1FWEEi2KzXZ6VXazR1okqDDa59xKNUkAIiIUyqYS8mqB0Jc'],
]
      ...
      <main className="px-4 pb-12 pt-24 lg:ml-64 lg:p-8 lg:pt-28">
        <section className="hero-gradient editorial-shadow relative overflow-hidden rounded-[28px] p-8 text-white lg:p-10">
          <div className="relative z-10 max-w-2xl">
            <h1 className="font-headline text-4xl font-extrabold tracking-tight lg:text-5xl">Welcome back, Alex.</h1>
          ...
          <div className="xl:col-span-7">
            ...
            <article className="editorial-shadow overflow-hidden rounded-[28px] border border-outline-variant/10 bg-white md:flex">
              <div className="relative md:w-2/5">
                <img className="h-full w-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDQoHpehiKE_8jtjAeiCbS_7HhSNmL4R0ASx1jSsupX2yUaQyunhAc2lkwtIT1rPeSiITzX1ao1XaW_wVNwsJ6wL4NgxvcIiSeMhrGO5zTisomoTyFfVeuj6-Ed_mHX4CmXzVW3qx6I-kDVm4VerdWQuGodAHJEFmPuCfny4WTAlUrlzH6NsHPtMOpOmRFLcCkJIzEq68tiNI2JCoMjJ1EwFUCkSTB2tqIp96tBMnSzfTrq2CDWUt9FOJpAEMmeiVqSw35McDy7GDw" alt="Annual Tech Symposium" />
              ...
              <div className="p-8 md:w-3/5">
                <h3 className="font-headline text-3xl font-extrabold">Annual Tech Symposium 2024</h3>
                <p className="mt-3 text-sm leading-relaxed text-on-surface-variant">
                  Join industry leaders from Silicon Valley and top researchers for a 2-day immersive experience on the future of AI and ethical engineering.
                </p>
                <div className="mt-6 flex flex-wrap gap-3">
                  <span className="rounded-full bg-surface-container-low px-4 py-2 text-xs font-semibold">Oct 12-14</span>
        ...
        <section id="clubs" className="mt-12">
          ...
          <div className="mt-6 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            {clubs.map(([title, type, image]) => (
              <article key={title} className="editorial-shadow rounded-[28px] border border-outline-variant/10 bg-white p-6 text-center transition-transform hover:scale-[1.02]">
                ...
                <p className="mt-1 text-[10px] font-bold uppercase tracking-[0.24em] text-primary">{type}</p>
                <Link
                  to="/committee-detail"
